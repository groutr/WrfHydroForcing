...
class input_forcings:
    ...
    def __init__(self, keyValue):
        ...
        self.t2dDownscaleOpt = 0
        self.lapseGrid = None
        self.rqiClimoGrid = None
        self.swDowscaleOpt = 0
        self.precipDownscaleOpt = 0
        self.nwmPRISM_numGrid = None
        self.nwmPRISM_denGrid = None
        self.q2dDownscaleOpt = 0
        self.psfcDownscaleOpt = 0
        self.t2dBiasCorrectOpt = 0
        self.swBiasCorrectOpt = 0
        self.precipBiasCorrectOpt = 0
        self.q2dBiasCorrectOpt = 0
        self.windBiasCorrectOpt = 0
        self.psfcBiasCorrectOpt = 0
        self.lwBiasCorrectOpt = 0
        self.esmf_lats = None
        self.esmf_lons = None
    ...
    def define_product(self):
        ...
        netcdf_variables = {
            ...
            18: ['TMP_80maboveground', 'SPFH_2maboveground',
                'UGRD_10maboveground', 'VGRD_10maboveground',
                'APCP_surface', 'PRES_surface'],
            19: ["DLWRF_surface", "DSWRF_surface", "PRES_surface",
                "TMP_2maboveground", "SPFH_2maboveground", "PRATE_surface",
                "uwnd", "vwnd", "P"]
        }
    ...
    def calc_neighbor_files(self,ConfigOptions,dCurrent,MpiConfig):
        ...
        find_neighbor_files = {
            ...
            19: time_handling.find_hwrf_neighbors
        }
